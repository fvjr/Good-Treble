...
function Navigation({
  ...
  return ( <
    ...
    >
    </a> </div> <div className = "d-flex flex-row-reverse">
    ...
    Why GOOD TREBLE </a> </li> <li className = "nav-item">
    <a className = "nav-link"
    href = "/#profile"
    onClick = {
      () => handlePageChange('Profile')
    } >
    Profile </a> </li> <li className = "nav-item">
    <a className = "nav-link"
    href = "#login"
    onClick = {
      () => handlePageChange('Login')
    } >
    Login </a> </li> <li className = "nav-item">
